...
async function verify() {
  ...
  const dataStaticJuly = await fetchHistoricalData(tsCode, '2024-07-01', '2024-07-05', 'unadjusted', 'dv_ratio');
  ...
  const dataTtmJuly = await fetchHistoricalData(tsCode, '2024-07-01', '2024-07-05', 'unadjusted', 'dv_ttm');
  ...
  const dataStaticAug = await fetchHistoricalData(tsCode, '2024-08-01', '2024-08-05', 'unadjusted', 'dv_ratio');
  ...
  const dataTtmAug = await fetchHistoricalData(tsCode, '2024-08-01', '2024-08-05', 'unadjusted', 'dv_ttm');
